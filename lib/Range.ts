 ...
 */
class Range {
  protected _startCell: any;
  protected _endCell: any;
  protected _style: any;
  protected _maxColumnNumber: any;
  protected _maxRowNumber: any;
  protected _minColumnNumber: any;
  protected _minRowNumber: any;
  protected _numColumns: any;
  protected _numRows: any;
  ...
  cell(ri, ci) {
    return this.sheet().cell(
      this._minRowNumber + ri,
      this._minColumnNumber + ci,
    );
  }
   ...
   * @private
   */
  _findRangeExtent(...args: any[]) {
    this._minRowNumber = Math.min(
      this._startCell.rowNumber(),
      this._endCell.rowNumber(),
    );
    this._maxRowNumber = Math.max(
      this._startCell.rowNumber(),
      this._endCell.rowNumber(),
    );
    this._minColumnNumber = Math.min(
      this._startCell.columnNumber(),
      this._endCell.columnNumber(),
    );
    this._maxColumnNumber = Math.max(
      this._startCell.columnNumber(),
      this._endCell.columnNumber(),
    );

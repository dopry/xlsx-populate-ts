 ...
 */
class StyleSheet {
  protected _bordersNode: any;
  protected _cellXfsNode: any;
  protected _fillsNode: any;
  protected _fontsNode: any;
  protected _nextNumFormatId: any;
  protected _node: any;
  protected _numFmtsNode: any;
  protected _numberFormatCodesById: any;
  protected _numberFormatIdsByCode: any;
  ...
  createStyle(sourceId) {
    ...
    borderNode.children = [
      xmlq.findChild(borderNode, "left") || {
        name: "left",
        attributes: {},
        children: [],
      },
    ...
    return new Style(
      this,
      this._cellXfsNode.children.length - 1,
      xfNode,
      fontNode,
      fillNode,
      borderNode,

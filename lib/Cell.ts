...
class Cell {
  protected _row: any;
  protected _formulaRef: any;
  protected _sharedFormulaId: any;
  protected _value: any;
  protected _formulaType: any;
  protected _formula: any;
  protected _columnNumber: any;
  protected _style: any;
  protected _styleId: any;
  protected _remainingAttributes: any;
  protected _remainingChildren: any;
  protected _remainingFormulaAttributes: any;
  ...
  active(...args: any[]) {
    return new ArgHandler("Cell.active")
      ...
      .case("boolean", (active) => {
        if (!active)
          throw new Error(
            "Deactivating cell directly not supported. Activate a different cell instead.",
          );
  ...
  getSharedRefFormula() {
    return this._formulaType === "shared"
      ? this._formulaRef && this._formula
      : undefined;
  }
  ...
  toXml() {
    ...
    if (this._formulaType != null) {
      ...
      if (typeof this._value === "string") {
        ...
        this._value instanceof RichText ||
        (typeof this._value === "object" &&
          this._value.constructor.name === "RichText")
      ) {
        // Hack to make Jasmine test work
        type = "s";
        text = this.workbook()
          .sharedStrings()
          .getIndexForString(this._value.toXml());
      }

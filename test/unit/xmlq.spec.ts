...
describe("xmlq", () => {
  describe("appendChild", () => {
    it("should append the child", () => {
      ...
      expect(node).toEqual({
        name: "parent",
        children: [{ name: "existing" }, { name: "new" }],
      });
    });
  ...
  describe("appendChildIfNotFound", () => {
    it("should append the child", () => {
      const node = { name: "parent", children: [{ name: "existing" }] };
      expect(xmlq.appendChildIfNotFound(node, "new")).toEqual({
        name: "new",
        attributes: {},
        children: [],
      });
    ...
    it("should not append the child", () => {
      const node = { name: "parent", children: [{ name: "existing" }] };
      expect(xmlq.appendChildIfNotFound(node, "existing")).toEqual({
        name: "existing",
      });
      expect(node).toEqual({
        name: "parent",
  ...
  describe("setChildAttributes", () => {
    it("should append the child with the attributes", () => {
      const node = { name: "parent", children: [{ name: "existing" }] };
      expect(
        xmlq.setChildAttributes(node, "new", { foo: 1, bar: null }),
      ).toEqual({ name: "new", attributes: { foo: 1 }, children: [] });
      expect(node.children).toEqual([
        { name: "existing" },
        { name: "new", attributes: { foo: 1 }, children: [] },
      ]);
    });
    ...
    it("should not append the child but should set the attributes", () => {
      const node = {
        name: "parent",
        children: [{ name: "existing", attributes: { bar: 1 } }],
      };
      expect(
        xmlq.setChildAttributes(node, "existing", { foo: 1, bar: null }),
      ).toEqual({ name: "existing", attributes: { foo: 1 } });
      expect(node).toEqual({
        name: "parent",
        children: [{ name: "existing", attributes: { foo: 1 } }],
      });
    });
  });

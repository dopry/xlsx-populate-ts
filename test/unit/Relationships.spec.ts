...
describe("Relationships", () => {
  ...
  describe("findById", () => {
    it("should return the relationship if matched", () => {
      expect(relationships.findById("rId1")).toBe(
        relationshipsNode.children[1],
      );
      expect(relationships.findById("rId2")).toBe(
        relationshipsNode.children[0],
      );
    });
  ...
  describe("findByType", () => {
    it("should return the relationship if matched", () => {
      expect(relationships.findByType("worksheet")).toBe(
        relationshipsNode.children[1],
      );
      expect(relationships.findByType("theme")).toBe(
        relationshipsNode.children[0],
      );
    });

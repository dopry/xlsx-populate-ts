  ...
  describe("styles", () => {
    ...
    describe("fontColor", () => {
      it("should get/set fontColor", () => {
        ...
        expect(fragment.style("fontColor")).toEqual({ rgb: "FF0000" });
        expect(fontNode.children).toEqual([
          { name: "color", attributes: { rgb: "FF0000" }, children: [] },
        ]);

        fragment.style("fontColor", 5);
        expect(fragment.style("fontColor")).toEqual({ theme: 5 });
        expect(fontNode.children).toEqual([
          { name: "color", attributes: { theme: 5 }, children: [] },
        ]);

        fragment.style("fontColor", { theme: 3, tint: -0.2 });
        expect(fragment.style("fontColor")).toEqual({ theme: 3, tint: -0.2 });
        expect(fontNode.children).toEqual([
          {
            name: "color",
        ...
        expect(fragment.style("fontColor")).toEqual({ rgb: "00FFFF" });
      });
    });
  });

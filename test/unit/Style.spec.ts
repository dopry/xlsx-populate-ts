...
describe("Style", () => {
  ...
  beforeEach(() => {
    styleSheet = createSpyObj("styleSheet", [
      "getNumberFormatCode",
      "getNumberFormatId",
    ]);
    id = "ID";
  ...
  describe("strikethrough", () => {
    it("should get/set strikethrough", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "strike", attributes: {}, children: [] },
      ]);
  ...
  describe("subscript", () => {
    it("should get/set subscript", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "vertAlign", attributes: { val: "subscript" }, children: [] },
      ]);
  ...
  describe("superscript", () => {
    it("should get/set superscript", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "vertAlign", attributes: { val: "superscript" }, children: [] },
      ]);
  ...
  describe("fontSize", () => {
    it("should get/set fontSize", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "sz", attributes: { val: 17 }, children: [] },
      ]);
  ...
  describe("fontFamily", () => {
    it("should get/set fontFamily", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "name", attributes: { val: "Comic Sans MS" }, children: [] },
      ]);
  ...
  describe("fontGenericFamily", () => {
    it("should get/set fontGenericFamily", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "family", attributes: { val: 1 }, children: [] },
      ]);
  ...
  describe("fontScheme", () => {
    it("should get/set fontScheme", () => {
      ...
      expect(fontNode.children).toEqual([
        { name: "scheme", attributes: { val: "minor" }, children: [] },
      ]);
  ...
  describe("fontColor", () => {
    it("should get/set fontColor", () => {
      ...
      fontNode.children = [
        { name: "color", attributes: { indexed: 7 }, children: [] },
      ];
  ...
  describe("justifyLastLine", () => {
    it("should get/set justifyLastLine", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { justifyLastLine: 1 }, children: [] },
      ]);
  ...
  describe("indent", () => {
    it("should get/set indent", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { indent: 3 }, children: [] },
      ]);
  ...
  describe("verticalAlignment", () => {
    it("should get/set verticalAlignment", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { vertical: "center" }, children: [] },
      ]);
  ...
  describe("wrapText", () => {
    it("should get/set wrapText", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { wrapText: 1 }, children: [] },
      ]);
  ...
  describe("shrinkToFit", () => {
    it("should get/set shrinkToFit", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { shrinkToFit: 1 }, children: [] },
      ]);
  ...
  describe("textDirection", () => {
    it("should get/set textDirection", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { readingOrder: 1 }, children: [] },
      ]);
      style.style("textDirection", "right-to-left");
      expect(style.style("textDirection")).toBe("right-to-left");
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { readingOrder: 2 }, children: [] },
      ]);
  ...
  describe("textRotation", () => {
    it("should get/set indent", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { textRotation: 15 }, children: [] },
      ]);
      style.style("textRotation", -25);
      expect(style.style("textRotation")).toBe(-25);
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { textRotation: 115 }, children: [] },
      ]);
  ...
  describe("angleTextCounterclockwise", () => {
    it("should get/set angleTextCounterclockwise", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { textRotation: 45 }, children: [] },
      ]);
  ...
  describe("rotateTextUp", () => {
    it("should get/set rotateTextUp", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { textRotation: 90 }, children: [] },
      ]);
  ...
  describe("verticalText", () => {
    it("should get/set verticalText", () => {
      ...
      expect(xfNode.children).toEqual([
        { name: "alignment", attributes: { textRotation: 255 }, children: [] },
      ]);
      ...
      expect(fillNode.children).toEqual([
        {
          ...
          children: [
            { name: "fgColor", attributes: { rgb: "FF0000" }, children: [] },
          ],
        },
      ]);
      ...
      expect(fillNode.children).toEqual([
        {
          ...
          attributes: { patternType: "solid" },
          children: [
            { name: "fgColor", attributes: { theme: 5 }, children: [] },
          ],
        },
      ]);
  ...
  describe("border", () => {
    ...
    describe("sideBorder", () => {
      it("should get/set sideBorder", () => {
        ...
        expect(style.style("bottomBorder")).toEqual({
          style: "double",
          color: { theme: 6 },
        });
  ...
  describe("numberFormat", () => {
    it("should get/set numberFormat", () => {
      ...
      expect(xfNode).toEqual({
        name: "xf",
        attributes: { numFmtId: 7 },
        children: [],
      });
      expect(style.style("numberFormat")).toBe("foo");

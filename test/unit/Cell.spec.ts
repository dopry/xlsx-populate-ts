...
describe("Cell", () => {
  ...
  beforeEach(() => {
    ...
    sharedStrings = createSpyObj("sharedStrings", [
      "getIndexForString",
      "getStringByIndex",
    ]);
    ...
    sheet = createSpyObj("sheet", [
      "createStyle",
      "activeCell",
      "updateMaxSharedFormulaId",
      "name",
      "column",
      "clearCellsUsingSharedFormula",
      "cell",
      "range",
      "hyperlink",
      "dataValidation",
  ...
  describe("clear", () => {
    ...
    it("should clear the cell with shared ref", () => {
      ...
      expect(sheet.clearCellsUsingSharedFormula).toHaveBeenCalledWith(
        "SHARED_FORMULA_ID",
      );
    });
  });
  ...
  describe("find", () => {
    ...
    it("should replace regex matches with function", () => {
      ...
      expect(cell.value).toHaveBeenCalledWith(
        "REPLACEMENT bar baz REPLACEMENT",
      );
  ...
  describe("style", () => {
    ...
    it("should set the values in the range", () => {
      ...
      expect(range.style).toHaveBeenCalledWith("foo", [
        [1, 2],
        [3, 4],
        [5, 6],
      ]);
  ...
  describe("value", () => {
    ...
    it("should set the values in the range", () => {
      ...
      expect(range.value).toHaveBeenCalledWith([
        [1, 2],
        [3, 4],
      ]);
    });
  ...
  describe("_parseNode", () => {
    ...
    it("should parse a shared formula", () => {
      ...
      expect(cell._remainingFormulaAttributes).toBeUndefined();
      expect(sheet.updateMaxSharedFormulaId).toHaveBeenCalledWith(
        "SHARED_INDEX",
      );
    });
    ...
    it("should preserve unknown formula attributes", () => {
      ...
      expect(cell._formulaRef).toBeUndefined();
      expect(cell._sharedFormulaId).toBeUndefined();
      expect(cell._remainingFormulaAttributes).toEqual({
        foo: "foo",
        bar: "bar",
      });
      expect(sheet.updateMaxSharedFormulaId).not.toHaveBeenCalled();
    ...
    it("should preserve unknown attributes and children", () => {
      ...
      expect(cell._remainingChildren).toEqual([
        { name: "foo" },
        { name: "bar" },
      ]);
    });

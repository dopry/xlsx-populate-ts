...
describe("ContentTypes", () => {
  ...
  describe("findByPartName", () => {
    it("should return the part if matched", () => {
      expect(contentTypes.findByPartName("/xl/worksheets/sheet1.xml")).toBe(
        contentTypesNode.children[2],
      );
      expect(contentTypes.findByPartName("/xl/workbook.xml")).toBe(
        contentTypesNode.children[1],
      );
    });
